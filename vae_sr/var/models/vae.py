...
class VAE(tf.keras.Model):
    ...
    def __init__(self, X_val, args, **kwargs):
        ...
        if not load_saved_model:
            ...
            # Encoder
            encoder_inputs = tf.keras.Input(shape=(self.nNodes, self.nNodes, 1))
            ...
            x = tf.keras.layers.Dense(args.nNodes * args.nNodes * 1, activation="relu")(x)
            decoder_outputs = tf.keras.layers.Reshape((args.nNodes, args.nNodes, 1))(x)
