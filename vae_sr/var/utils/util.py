...
def load_traindata(args):
    L_train = np.load(os.path.join(args.datapath, 'data/gwn_{}.1_{}_{}_mae_p2/train_LL_np.npy'.format(args.dataset,
                                                                                                      args.seq_len_x,
                                                                                                      args.seq_len_y)))
    L_val = np.load(os.path.join(args.datapath, 'data/gwn_{}.1_{}_{}_mae_p2/val_LL_np.npy'.format(args.dataset,
                                                                                                  args.seq_len_x,
                                                                                                  args.seq_len_y)))
    X_train = np.load(os.path.join(args.datapath, 'data/gwn_{}.1_{}_{}_mae_p2/train_TM_np.npy'.format(args.dataset,
                                                                                                      args.seq_len_x,
                                                                                                      args.seq_len_y)))
    X_val = np.load(os.path.join(args.datapath, 'data/gwn_{}.1_{}_{}_mae_p2/val_TM_np.npy'.format(args.dataset,
                                                                                                  args.seq_len_x,
                                                                                                  args.seq_len_y)))
    A_train = np.load(os.path.join(args.datapath, 'data/gwn_{}.1_{}_{}_mae_p2/train_A_np.npy'.format(args.dataset,
                                                                                                     args.seq_len_x,
                                                                                                     args.seq_len_y)))
    A_val = np.load(os.path.join(args.datapath, 'data/gwn_{}.1_{}_{}_mae_p2/val_A_np.npy'.format(args.dataset,
                                                                                                 args.seq_len_x,
                                                                                                 args.seq_len_y)))
